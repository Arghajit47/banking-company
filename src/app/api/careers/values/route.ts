...
const CAREERS_VALUES: CareersValueItem[] = [
  {
    id: 1,
    icon: "",
    title: "Integrity",
...
export async function GET(): Promise<NextResponse<CareersValuesResponse>> {
  return NextResponse.json({ values: CAREERS_VALUES });
}
