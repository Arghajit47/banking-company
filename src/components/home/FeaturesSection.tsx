    ...
    >
      <div className="flex items-start gap-[10px]">
        <h3
          ...
          className="flex-1 text-[18px] font-normal leading-[150%] text-white desktop:text-[22px]"
        >
          {feature.title}
        </h3>
        <Image
    ...
    >
      <div className="mb-[50px] lg:pr-[300px]" data-testid="features-header">
        <h2
          ...
          className="mb-[14px] font-lexend text-[28px] font-medium leading-[150%] text-white md:text-[38px] desktop:text-[48px]"
        >
