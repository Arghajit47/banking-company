...
describe("SignUpForm", () => {
  ...
  // BC-182 — heading size ladder, all three Figma frames. Figma "Sign Up":
  // mobile 116:12104 = 28px @390, laptop 116:11940 = 38px @1440,
  // desktop 67:272 = 48px @1920. The base class was the *desktop* 48px, so
